                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td>
                                                      ...
                                                      <input type="text" name="no_proyecto" class="form-control" placeholder="Número de proyecto">
												  ...
												  <td>
													...
													<td>
														<div class="s-14 c-text-alt">Clasificación Programatica CONAG</div>
														<select name="idconag" class="select2">
															<option value="">--Select Please--</option>
                                                            @foreach ($rowsClasProg as $v)
                                                                <option value="{{ $v->id }}" >{{ $v->clasificacion }}</option>
                                                            @endforeach
														</select>
													</td>
...
query();
    ...
    $(document).on("click",".btnedit",function(e){
        e.preventDefault();
        modalMisesa("{{ URL::to($pageModule.'/update') }}",{id:$(this).attr("id"), idy:$(this).attr("idy")}, "Proyecto",'50%');
    });
</script>		
@stop