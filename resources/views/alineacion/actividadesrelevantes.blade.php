            ...
            <div class="sbox border-t5-green">
                ...
                <div class="bg-green-rgba p-sm box-height-card"> 	
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 no-padding">
                        ...
                        <textarea name="paso1" rows="3" id="txt_paso1" class="form-control border-all-green bg-transparent font-bold c-primary-alt" placeholder="Texto político" onKeyUp="unirTextos()" required></textarea>
                        ...
                        <div class="m-t-md m-b-xs">
                            <select name="slt_paso1" id="text_1" class="mySelect2 full-width sltconector" onchange="myDelegaciones()">
                                ...
                                @foreach ($conectores as $c)
                                    @if($c->tipo == 1)
                                        <option value="{{ $c->idpdm_alineacion_conectores }}">{{ $c->descripcion }}</option>
                                    @endif   
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="sbox border-t5-pink">
                ...
                <div class="bg-pink-rgba p-sm box-height-card"> 	
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 no-padding">
                        ...
                        <textarea name="paso2" rows="3" id="txt_paso2" class="form-control border-all-pink bg-transparent font-bold c-primary-alt" placeholder="Enunciado de Valor" onKeyUp="unirTextos()" required></textarea>
            ...
            <div class="sbox border-t5-yellow">
                ...
                <div class="bg-yellow-rgba p-sm box-height-card"> 	
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 no-padding">
                        ...
                        <textarea name="paso3" rows="3" id="txt_paso3" class="form-control border-all-yellow bg-transparent font-bold c-primary-alt" placeholder="Logro Cuantitativo" onKeyUp="unirTextos()" required></textarea>
                        <div class="m-t-md m-b-xs">
            ...
            <div class="sbox border-t5-green">
                ...
                <div class="bg-green-rgba p-sm box-height-card"> 	
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 no-padding">
                        ...
                        <textarea name="paso4" rows="3" id="txt_paso4" class="form-control border-all-green bg-transparent font-bold c-primary-alt" placeholder="Población Beneficiada" onKeyUp="unirTextos()" required></textarea>
                        <div class="m-t-md m-b-xs">
                ...
                <div class="bg-pink-rgba p-sm box-height-card"> 	
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 no-padding">
                        <select name="iddelegacion[]" id="iddelegacion" multiple class='testselect2 full-width' onchange="myDelegaciones()">
                            ...
                            <option value="{{ $d->iddelegacion }}">{{ $d->descripcion }}</option>
                            @endforeach
                        </select>
            ...
            <div class="sbox border-t5-yellow">
                ...
                <div class="bg-yellow-rgba p-sm box-height-card"> 	
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 no-padding">
                        ...
                        <textarea name="paso6" rows="3" id="txt_paso6" class="form-control border-all-yellow bg-transparent font-bold c-primary-alt" placeholder="Monto de la inversión" onKeyUp="unirTextos()" required></textarea>
    ...
    <section class="col-sm-12 col-md-12 col-lg-12">
        <div class="sbox">
            ...
            <div class="bg-white p-sm"> 	
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                     <textarea name="comentarios" rows="4" class="form-control font-bold fun no-borders" placeholder="Informe de Gobierno" id="_comentarios" readonly style="background: transparent;"></textarea>
                </div>
...
<script>
    ...
    $("#saveInfo").on("submit", function(e){
      ...
      var formData = new FormData(document.getElementById("saveInfo"));
        $.ajax("{{ URL::to('alineacion/actividadesrelevantes?idlinea_accion='.$idlinea_accion) }}", {
            type: 'post',
            dataType: "html",
            data: formData,
            cache: false,
