...
<main class="page-content row bg-body">
    ...
    <section class="page-header bg-body">
        ...
        <ul class="breadcrumb bg-body s-14">
            ...
            <li class="active"><i>Dependencias Auxiliares</i></li>
            <li>{{ $ins->municipio }}</li>
    ...
    <article class="col-md-12">
        <section class="page-content-wrapper no-padding">
            <div class="sbox animated fadeInRight ">
                        <div class="sbox-title border-t-yellow"> <h4> Dependencias Auxiliares</h4></div>
...
<script>
    ...
    $(document).on("click",".btneliminar",function(e){
		...
		swal({
			title : 'Estás seguro de eliminar la dependencia auxiliar?',
			icon : 'warning',
			buttons : true,
			dangerMode : true
		}).then((willDelete) => {
    ...
    $(document).on("click",".btnagregar",function(e){
        e.preventDefault();
        modalMisesa("{{ URL::to($pageModule.'/update') }}",{id:$(this).attr("id"), idy: "{{$idy}}"}, "Agregar Dependencia Auxiliar",'50%');
    })
</script>
</main>		
@stop