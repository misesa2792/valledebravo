  ...
  <template id="component_body">
    <article class="col-md-12 no-padding">
      ...
      <section class="col-sm-12 col-md-12 col-lg-12 b-r-5 p-xs m-b-xs" v-if="count == true">
          ...
          <table class="table no-margins table-hover" style="border:none">
              <tr class="t-tr-s14 c-text-alt">
                <td colspan="14" class="no-borders"></td>
              ...
              <tr class="t-tr-s14 c-text-alt">
                ...
                <td rowspan="2" class="no-borders"></td>
                <td rowspan="2" class="no-borders">Indicadores</td>
              ...
              <tr class="t-tr-s14 c-text-alt" v-for="(p, indexp) in row">
                ...
                <td class="no-borders">
                  <div class="btn-group">
                    <button type="button" class="btn btn-xs btn-white dropdown-toggle b-r-c s-14 b-r-30" data-toggle="dropdown"><span class="fa fa-ellipsis-h c-primary-alt"> FODA </span></button>
                  ...
                  <table class="table table-bordered no-margins">
                    ...
                    <tr v-for="m in p.indicadores">
                      ...
                      <td class="text-center" width="25">
                        <div v-if="access.t1 == 'si'">
                          <comp-btn-pdf :url="m.url1" :id="m.id" :trim="'1'" :type="'1'"></comp-btn-pdf>
                        </div>
                      </td>
                      <td class="text-center" width="25">
                        <div v-if="access.t2 == 'si'">
                          <comp-btn-pdf :url="m.url2" :id="m.id" :trim="'2'" :type="'1'"></comp-btn-pdf>
                        </div>
                      </td>
                      <td class="text-center" width="25">
                        <div v-if="access.t3 == 'si'">
                          <comp-btn-pdf :url="m.url3" :id="m.id" :trim="'3'" :type="'1'"></comp-btn-pdf>
                        </div>
                      </td>
                      <td class="text-center" width="25">
                        <div v-if="access.t4 == 'si'">
                          <comp-btn-pdf :url="m.url4" :id="m.id" :trim="'4'" :type="'1'"></comp-btn-pdf>
                        </div>
                      </td>
                    </tr>
                  </table>
      ...
      <section class="col-sm-12 col-md-12 col-lg-12 b-r-5 p-xs m-b-xs" v-if="count == false">
        ...
        <table class="table no-margins table-hover" style="border:none">
          <tr class="t-tr-s14 c-text-alt">
            <td colspan="13" class="no-borders"></td>
            <td colspan="4" class="no-borders c-text-alt text-center">Oficio Dictamen de Reconducción</td>
          </tr>
          <tr class="t-tr-s14 c-text-alt">
            <td colspan="13" class="no-borders"></td>
...
<template id="comp_btn_pdf_reverse">
    ...
    <section class="col-md-12 no-padding m-t-md m-b-md">
      <div class="col-md-12 p-rel">
          <ul class="nav nav-tabs text-right">
            <li>
              <button type="button" onclick="location.href='{{ URL::to($pageModule.'/principal?idy='.$row->idanio) }}' " class="btn bg-default c-text b-r-5 tips" title="Regresar" style="margin-right:15px;">
                <i class="fa  fa-arrow-circle-left "></i> Regresar
              </button>
            </li>
            <li>
              <button type="button" :class="'btn tips '+(menu == 1 ? 'bg-blue c-white' : 'bg-white c-text')" @click.prvent="selectYear(1)" title="Indicadores">
  ...
  Vue.component('component-body', {
    ...
    window.user = {
        group_id: {{ json_encode(Auth::user()->group_id) }}, // Escapar correctamente
