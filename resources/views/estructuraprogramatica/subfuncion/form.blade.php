<form id="saveInfo" method="post" class="form-horizontal">
	<div class="col-md-12">
        ...
        {!! Form::hidden('idfuncion', $idfuncion,array('class'=>'form-control', 'placeholder'=>'',   )) !!}
        ...
        <div class="form-group  " >
          <label for="Descripcion" class=" control-label col-md-4 text-left s-16 c-text-alt"> Subfunción :</label>
          <div class="col-md-6">
...
<script>
    $("#saveInfo").on("submit", function(e){
      ...
      var formData = new FormData(document.getElementById("saveInfo"));
        $.ajax("{{ URL::to('estructuraprogramatica/savesubfun') }}", {
            type: 'post',
            dataType: "html",
            data: formData,
            cache: false,
