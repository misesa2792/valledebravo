...
<main class="page-content row bg-body">
	...
	<div class="col-md-12 text-center d-flex flex-wrap justify-content-center">
		...
		@foreach ($rowsAnios as $row)
			<div class="item-file-list b-r-c no-padding b-r-10 m-2" style="border:none">
			<div class="item-content cursor text-center">
					<a href="{{ URL::to($pageModule.'/dependencias?idy='.$row->idanio.'&type='.$type)}}" title="{{ $row->anio }}" class="ai-border">
					<div class="h-95 d-table w-100">
					<div class="d-table-cell align-middle">
						<i class="fa fa-calendar {{ date('Y') == $row->anio ? 'c-success' : 'c-text-alt' }} s-60"></i>
					</div>
					</div>
