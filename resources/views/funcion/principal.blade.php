                                  ...
                                  <div class="col-md-12 no-padding m-b">
                                      ...
                                      <table class="table no-margins b-gray bg-white">
                                          <tbody>
                                              <tr>
                                                  <td>
                                                      <div class="s-14 c-text-alt">No. Función</div>
                                                      <input type="text" name="no_funcion" class="form-control" placeholder="Número de función">
                                                      <input type="hidden" name="page" value="1" id="pagep">
                                                  </td>
												  <td>
														<div class="s-14 c-text-alt">Función</div>
														<input type="text" name="funcion" class="form-control" placeholder="Nombre de la función">
													</td>
