<form id="saveInfo" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <textarea name="descripcion"  rows="6" class="form-control" placeholder="Ingresa Subtema" required>{{ $row->descripcion }}</textarea>
        </div>
    </div> 
...
<script>
    $("#saveInfo").on("submit", function(e){
      ...
      var formData = new FormData(document.getElementById("saveInfo"));
        $.ajax("{{ URL::to('pdm/editarsubtema?idps='.$idps) }}", {
            type: 'post',
            dataType: "html",
            data: formData,
            cache: false,
