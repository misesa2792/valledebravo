...
<div class="" style="padding:30px;">			
  ...
  <div class="form-group form-defaultval">
  	<label for="defaultval" class=" control-label col-md-4">Default Value</label>
  	<div class="col-md-8">
  		<input name="defaultval" type="text" id="defaultval" class="form-control input-sm" value="<?php echo (isset($f['option']['defaultval']))?($f['option']['defaultval']):"";?>" />
  	</div>
  </div>
  <div class="form-group" >
