...
<main class="page-content row bg-body">
    ...
    <section class="page-header bg-body">
      ...
      <ul class="breadcrumb bg-body s-14">
        ...
        <li class="active"><i>Actividad usuarios</i></li>
      </ul>	  
  </section>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center no-borders" width="30">
                                                      ...
                                                      <a href="{{ URL::to($pageModule.'/users') }}" class="btn btn-xs btn-white b-r-30"><i class="fa fa-eraser var"></i> Limpiar</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                      </table>
...
query();
    function query(){
        ...
        $.ajax("{{ URL::to($pageModule.'/usersearch') }}", {
            type: 'post',
            dataType: "html",
            data: formData,
            cache: false,
