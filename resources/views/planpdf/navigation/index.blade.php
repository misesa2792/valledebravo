...
<main class="page-content row bg-body">
    ...
    <section class="page-header bg-body">
      ...
      <ul class="breadcrumb bg-body s-14">
        ...
        <li class="active"><i>Navegación</i></li>
      </ul>	  
  </section>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="no-borders" width="80%">
                                                     ...
                                                     <td class="no-borders">
                                                        <div class="s-14 c-text-alt">Tipo</div>
                                                        <select name="tipo" id="nopagina" class="form-control">
                                                            <option value=""> Tipo de navegación </option>
                                                    ...
                                                    <td class="text-center no-borders" width="30">
                                                      ...
                                                      <a href="{{ URL::to($pageModule.'/navigation') }}" class="btn btn-xs btn-white b-r-30"><i class="fa fa-eraser var"></i> Limpiar</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                      </table>
...
query();
    function query(){
        ...
        $.ajax("{{ URL::to($pageModule.'/navigationsearch') }}", {
            type: 'post',
            dataType: "html",
            data: formData,
            cache: false,
