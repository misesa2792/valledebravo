                                  ...
                                  <div class="col-md-12 no-padding m-b">
                                      ...
                                      <table class="table no-margins b-gray bg-white">
                                          <tbody>
                                              <tr>
                                                  <td>
                                                      <div class="s-14 c-text-alt">No. Programa</div>
												  ...
												  <td>
														<div class="s-14 c-text-alt">Programa</div>
														<input type="text" name="programa" class="form-control" placeholder="Nombre del programa">
													</td>
													<td>
														<div class="s-14 c-text-alt">Pilar</div>
														<select name="idpdm_pilares" class="select2">
															<option value="">--Select Please--</option>
															@foreach ($pilares as $key => $p)
																<option value="{{ $p->id }}">{{ $p->pilar }}</option>
															@endforeach
														</select>
													</td>
...
query();
    ...
    $(document).on("click",".btnmatriz",function(e){
        e.preventDefault();
        modalMisesa("{{ URL::to($pageModule.'/matriz') }}",{id:$(this).attr("id"), idy:$(this).attr("idy"), no:$(this).attr("no")}, "Matriz",'90%');
    });
</script>		
@stop