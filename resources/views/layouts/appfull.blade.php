...
<link rel="shortcut icon" href="{{ asset('ses.ico')}}" type="image/x-icon">
		...
		<link href="{{ asset('mass/js/plugins/jasny-bootstrap/css/jasny-bootstrap.min.css')}}" rel="stylesheet">
		<link href="{{ asset('mass/fonts/awesome/css/font-awesome.min.css')}}" rel="stylesheet">
		<link href="{{ asset('mass/js/plugins/bootstrap.summernote/summernote.css')}}" rel="stylesheet">
		<link href="{{ asset('mass/js/plugins/datepicker/css/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
		<link href="{{ asset('mass/js/plugins/bootstrap.datetimepicker/css/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
		<link href="{{ asset('mass/js/plugins/iCheck/skins/square/green.css')}}" rel="stylesheet">
		<link href="{{ asset('mass/js/plugins/fancybox/jquery.fancybox.css') }}" rel="stylesheet">
		...
		<link href="{{ asset('mass/css/sesmas.css?v2.77')}}" rel="stylesheet">

		<script type="text/javascript" src="{{ asset('mass/js/plugins/jquery.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/sesmas.js?v1.16') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/jquery.cookie.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/jquery-ui.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/iCheck/icheck.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/fancybox/jquery.fancybox.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/prettify.js') }}"></script>
		...
		<script type="text/javascript" src="{{ asset('mass/js/plugins/bootstrap.datetimepicker/js/bootstrap-datetimepicker.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/bootstrap/js/bootstrap.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/jasny-bootstrap/js/jasny-bootstrap.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/jquery.form.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/jquery.jCombo.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/toastr/toastr.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/bootstrap.summernote/summernote.min.js') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/simpleclone.js') }}"></script>

	{{--
		vue local vue.js, produccion vuemin.js
		--}}
		<script type="text/javascript" src="{{ asset('mass/js/plugins/vue/vue.js?v1.1') }}"></script>
		<script type="text/javascript" src="{{ asset('mass/js/plugins/vue/vue-resource.js?v1.1') }}"></script>
...
jQuery(document).ready(function ($) {
	...
	{
		token = $("input[name='_token']").value;
	}
    Vue.http.headers.common['X-CSRF-TOKEN'] = token;//document.querySelector('#_token').getAttribute('value');
 });
</script>
@yield('scripts')
</body>
