    ...
    <section class="table-resp">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td class="s-16 no-borders">
                            <input type="text" name="fecha" value="{{ $data['fecha'] }}" class="form-control border-b-1-dashed c-black" placeholder="MUNICIPIO, MÉXICO A 00 DE 0000"  required>
                        </td>
                    </tr>
                    <tr>
                        <td class="s-16 no-borders">Oficio:</td>
                        <td class="no-borders">
                            <input type="text" name="oficio" class="form-control border-b-1-dashed c-black" placeholder="00000000000/0-0000-0/0000" required>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <article class="col-md-12 m-t-md">
            <table class="table table-bordered bg-white">
                <tr class="t-tr-s16">
                    <td><span class="c-text-alt">Dependencia:</span> {{ $data['dep_int']['no_dep_gen'].' '.$data['dep_int']['dep_gen'] }}</td>
                </tr>
                <tr class="t-tr-s16">
                    <td><span class="c-text-alt">Dependencia Auxiliar:</span> {{ $data['dep_int']['no_dep_aux'].' '.$data['dep_int']['dep_aux'] }}</td>
                </tr>
                <tr class="t-tr-s16">
                    <td><span class="c-text-alt">Programa presupuestario:</span> {{ $data['dep_int']['no_programa'].' '.$data['dep_int']['programa'] }}</td>
                </tr>
                <tr class="t-tr-s16">
                    <td><span class="c-text-alt">Objetivo:</span> {{ $data['dep_int']['obj_programa'] }}</td>
                </tr>
                <tr class="t-tr-s16">
                    <td><span class="c-text-alt">Clave y denominación del Proyecto:</span> {{ $data['dep_int']['no_proyecto'].' '.$data['dep_int']['proyecto'] }}</td>
                </tr>
            </table>
        </article>
			...
			<table class="table">
                ...
                <tr class="t-tr-s14 c-text-alt">
                    <td width="33%" class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="{{ $data['footer']['t_secretario'] }}" name="title1" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="SECRETARIO DEL AYUNTAMIENTO" required>
                    ...
                    <td width="33%" class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="{{ $data['footer']['t_uippe'] }}" name="title2" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="TITULAR DE LA UIPPE" required>
                    ...
                    <td width="33%" class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="{{ $data['footer']['t_tesoreria'] }}" name="title3" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="TESORERO MUNICIPAL" required>
                ...
                <tr class="t-tr-s14 c-text-alt">
                    <td width="33%" class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="{{ $data['footer']['t_prog_pres'] }}" name="title4" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="JEFE DEL DEPTO. DE PROGRAMACIÓN Y CONTROL PRESUPUESTAL" required>
                    ...
                    <td width="33%" class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="{{ $data['footer']['t_egresos'] }}" name="title5" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="DIRECTOR DE EGRESOS" required>
      ...
      swal({
        ...
        if(willDelete){
                ...
                formData.append("idam", "{{ $idam }}");
                    $.ajax("{{ URL::to($pageModule.'/generatepdfti') }}", {
                        type: 'post',
                        dataType: "html",
                        data: formData,
                        cache: false,
