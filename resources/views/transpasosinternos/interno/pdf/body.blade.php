...
<p class="s-12 text-justify">Por este conducto solicito es tan gentil de efectuar los movimientos, mediante los traspasos presupuestarios correspondientes  y en su caso las ampliaciones presupuestarias, de conformidad con lo establecido en el artículos 317 del Codigo Financiero del Estado de Mexico y Municipios vigente que a continuación se relacionan: </p>

<table width="100%" class="my-table" >
    <tr class="s-12">
        <td><span class="s-10">Dependencia: {{ $data['dep_int']['no_dep_gen'].' '.$data['dep_int']['dep_gen'] }}</span> </td>
    </tr>
    <tr class="s-12">
        <td><span class="s-10">Dependencia Auxiliar: {{ $data['dep_int']['no_dep_aux'].' '.$data['dep_int']['dep_aux'] }}</span></td>
    </tr>
    <tr class="s-12">
        <td><span class="s-10">Programa presupuestario: {{ $data['dep_int']['no_programa'].' '.$data['dep_int']['programa'] }}</span> </td>
    </tr>
    <tr class="s-12">
        <td><span class="s-10">Objetivo: {{ $data['dep_int']['obj_programa'] }}</span> </td>
    </tr>
    <tr class="s-12">
        <td><span class="s-10">Clave y denominación del Proyecto: {{ $data['dep_int']['no_proyecto'].' '.$data['dep_int']['proyecto'] }}</span> </td>
    </tr>
</table>
<br>
