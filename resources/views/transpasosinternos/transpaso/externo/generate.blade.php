                ...
                <table class="table">
                    <tr>
                        ...
                        <td class="s-16 no-borders">
                            <input type="text" name="fecha" value="{{ $row['header']['municipio'] }}, MÉXICO A {{ date('d') }} {{ mb_strtoupper(SiteHelpers::mes(date('m'))) }} DE {{ date('Y') }}" class="form-control border-b-1-dashed" placeholder="MUNICIPIO, MÉXICO A 00 DE 0000"  required>
                        </td>
                    </tr>
                    <tr>
                ...
                @else 
                    ...
                    @endforeach
                        @for ($i=0 ; $i < $row['resta']; $i++)
                            <tr class="t-tr-s14 c-text-alt bg-white">
                                <td class="text-center c-white">TE</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
			...
			<table class="table table-bordered">
                ...
                <tr class="t-tr-s14 c-text-alt">
                    <td class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="" name="txt_coor_apoyo" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="COORDINADOR DE APOYO TÉCNICO" onkeyup="MassMayusculas(this);" required>
                    ...
                    <td colspan="2" class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="" name="txt_del_pres" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="DELEGADA ADMINISTRATIVA DE LA TESORERÍA MUNICIPAL" onkeyup="MassMayusculas(this);" required>
                ...
                <tr class="t-tr-s14 c-text-alt">
                    <td width="33%" class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="{{ $row['footer']['prog_pres'] }}" name="txt_programacion" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="JEFE DEL DEPTO. DE PROGRAMACIÓN Y CONTROL PRESUPUESTAL" onkeyup="MassMayusculas(this);" required>
                    ...
                    <td width="33%" class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="{{ $row['footer']['egresos'] }}" name="txt_egresos" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="DIRECTOR DE EGRESOS" onkeyup="MassMayusculas(this);" required>
                    ...
                    <td width="33%" class="bg-white">
                        ...
                        <br>
                        <br>
                        <input type="text" value="{{ $row['footer']['tesorero'] }}" name="txt_tesorero" class="form-control border-b-1-dashed text-center c-black font-bold" placeholder="TESORERO MUNICIPAL" onkeyup="MassMayusculas(this);" required>
      ...
      swal({
        ...
        if(willDelete){
                ...
                formData.append("id", "{{ $id }}");
                    $.ajax("{{ URL::to($pageModule.'/generatepdfte?k='.$token) }}", {
                        type: 'post',
                        dataType: "html",
                        data: formData,
                        cache: false,
