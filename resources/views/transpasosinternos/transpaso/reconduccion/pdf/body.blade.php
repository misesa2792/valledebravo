        ...
        <td width="50%" class="text-top">
            <table width="100%"cellspacing="0" class="my-table-top">
                ...
                <tr>
                    ...
                    <td width="70%" height="30" class="border-t">{{ $row['dep_int']['no_programa'].' '.$row['dep_int']['programa'] }}</td>
                </tr>
                <tr>
                    <td width="100%" height="70" colspan="2" class="border-t"><strong>Objetivo:</strong> {{ $row['dep_int']['obj_programa'] }}</td>
                </tr>
            </table>
        </td>
        <td width="50%" class="text-top">
            <table width="100%"cellspacing="0" class="my-table-top">
                ...
                <tr>
                    <td width="20%" class="border-t">Programa presupuestario:</td>
                    <td width="70%" height="30" class="border-t">{{ $row['dep_ext']['no_programa'].' '.$row['dep_ext']['programa'] }}</td>
                </tr>
                <tr>
                    <td width="100%" height="70" colspan="2" class="border-t"><strong>Objetivo:</strong> {{ $row['dep_ext']['obj_programa'] }}</td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <th width="50%" class="text-top">
                <table width="100%" cellspacing="0" class="my-table">
                    ...
                    <tr>
                        <td class="s-8 bg-white text-center" height="45">{{ $row['dep_int']['no_proyecto'].' '.$row['dep_int']['clasificacion'] }}</td>
        ...
        <th width="50%" class="text-top">
                <table width="100%" cellspacing="0" class="my-table">
                    ...
                    <tr>
                        <td class="s-8 bg-white text-center" height="45">{{ $row['dep_ext']['no_proyecto'].' '.$row['dep_ext']['clasificacion'] }}</td>
