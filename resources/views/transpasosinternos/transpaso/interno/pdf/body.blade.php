...
<table width="100%" class="my-table" >
    <tr class="s-12">
        <td><span class="s-10">Dependencia: {{ $row['dep_int']['no_dep_gen'].' '.$row['dep_int']['dep_gen'] }}</span> </td>
    </tr>
    <tr class="s-12">
        <td><span class="s-10">Dependencia Auxiliar: {{ $row['dep_int']['no_dep_aux'].' '.$row['dep_int']['dep_aux'] }}</span></td>
    </tr>
    <tr class="s-12">
        <td><span class="s-10">Programa presupuestario: {{ $row['dep_int']['no_programa'].' '.$row['dep_int']['programa'] }}</span> </td>
    </tr>
    <tr class="s-12">
        <td><span class="s-10">Objetivo: {{ $row['dep_int']['obj_programa'] }}</span> </td>
    </tr>
    <tr class="s-12">
        <td><span class="s-10">Clave y denominación del Proyecto: {{ $row['dep_int']['no_proyecto'].' '.$row['dep_int']['proyecto'] }}</span> </td>
    </tr>
</table>
<br>
