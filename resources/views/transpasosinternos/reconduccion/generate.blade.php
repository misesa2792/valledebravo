        ...
        <td width="50%">
            <table id="table" width="100%" cellspacing="0" class="border bg-white">
                ...
                <tr>
                    ...
                    <td width="70%" class="border-t">{{ $data['dep_int']['no_programa'].' '.$data['dep_int']['programa'] }}</td>
                </tr>
                <tr>
                    <td width="100%" colspan="2" class="border-t"><strong>Objetivo:</strong> {{ $data['dep_int']['obj_programa'] }}</td>
                </tr>
                <tr>
                    <td width="20%" class="border-t">Proyecto presupuestario:</td>
                    <td width="70%" class="border-t">{{ $data['dep_int']['no_proyecto'].' '.$data['dep_int']['proyecto'] }}</td>
                </tr>
            </table>
        </td>
        <td width="50%">
            <table id="table" width="100%" cellspacing="0" class="border bg-white">
                ...
                <tr>
                    <td width="20%" class="border-t">Programa presupuestario:</td>
                    <td width="70%" class="border-t">{{ $data['dep_ext']['no_programa'].' '.$data['dep_ext']['programa'] }}</td>
                </tr>
                <tr>
                    <td width="100%" colspan="2" class="border-t"><strong>Objetivo:</strong> {{ $data['dep_ext']['obj_programa'] }}</td>
                </tr>
                <tr>
                    <td width="20%" class="border-t">Proyecto presupuestario:</td>
                    <td width="70%" class="border-t">{{ $data['dep_ext']['no_proyecto'].' '.$data['dep_ext']['proyecto'] }}</td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <th width="50%" style="vertical-align: text-top;">
                <table width="100%" cellspacing="0" class="border">
                    ...
                    <tr>
                        <td class="s-8 bg-white text-center">{{ $data['dep_int']['no_proyecto'].' '.$data['dep_int']['clasificacion'] }}</td>
        ...
        <th width="50%" style="vertical-align: text-top;">
                <table width="100%" cellspacing="0" class="border">
                    ...
                    <tr>
                        <td class="s-8 bg-white text-center">{{ $data['dep_ext']['no_proyecto'].' '.$data['dep_ext']['clasificacion'] }}</td>
...
<table id="table" width="100%" class="m-t-sm">
    ...
    <tr>
        <td>
            <textarea name="texto1" class="form-control" rows="3" placeholder="De la cancelación o reducción de metas de actividad y/o recursos del Proyecto. (impacto o repercusión programática)"></textarea>
        </td>
    </tr>
</table>
...
<table id="table" width="100%" class="m-t-sm">
    ...
    <tr>
        <td>
            <textarea name="texto2" class="form-control" rows="3" placeholder="De creación o reasignación de metas de actividad y/o recursos al proyecto (Beneficio, Impacto, Repercusión programática)."></textarea>
        </td>
    </tr>
</table>
...
<table id="table" width="100%" class="m-t-sm">
    ...
    <tr>
        <td>
            <textarea name="texto3" class="form-control" rows="3" placeholder="Identificación del Origen de los recursos."></textarea>
        </td>
    </tr>
</table>
...
<table id="table" width="100%" class="m-t-sm">
    <tr>
        <td width="30%" class="text-center border bg-white">
            ...
            <div class="c-white">.</div>
            <div>
                <input type="text" value="" name="firma1" class="form-control text-center fun no-borders" style="border-bottom:2px solid var(--border-color) !important;" placeholder="Ingresa Nombre" required>
            </div>
        ...
        <td width="25%" class="text-center border bg-white">
            ...
            <div class="c-white">.</div>
            <div>
                <input type="text" value="{{ $data['footer']['t_tesoreria'] }}" name="firma2" class="form-control text-center fun no-borders" style="border-bottom:2px solid var(--border-color) !important;" placeholder="Ingresa Nombre" required>
            </div>
            <div><strong>Nombre y Firma</strong></div>
        </td>
        <th width="5%" class="text-center"></th>
        <td width="25%" class="text-center border bg-white">
            ...
            <div class="c-white">.</div>
            <div>
                <input type="text" value="{{ $data['footer']['t_uippe'] }}" name="firma3" class="form-control text-center fun no-borders" style="border-bottom:2px solid var(--border-color) !important;" placeholder="Ingresa Nombre" required>
            </div>
            <div><strong>Nombre y Firma</strong></div>
        </td>
    </tr>
      ...
      swal({
        ...
        if(willDelete){
                ...
                formData.append("idam", "{{ $idam }}");
                    $.ajax("{{ URL::to($pageModule.'/generatepdfrec') }}", {
                        type: 'post',
                        dataType: "html",
                        data: formData,
                        cache: false,
