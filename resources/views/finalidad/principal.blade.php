                                  ...
                                  <div class="col-md-12 no-padding m-b">
                                      ...
                                      <table class="table no-margins b-gray bg-white">
                                          <tbody>
                                              <tr>
                                                  <td>
                                                      <div class="s-14 c-text-alt">No. Finalidad</div>
                                                      <input type="text" name="no_finalidad" class="form-control" placeholder="Número de finalidad">
                                                      <input type="hidden" name="page" value="1" id="pagep">
                                                  </td>
												  <td>
														<div class="s-14 c-text-alt">Finalidad</div>
														<input type="text" name="finalidad" class="form-control" placeholder="Nombre de la finalidad">
													</td>
