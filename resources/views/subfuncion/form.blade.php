<form id="saveInfo" method="post" class="form-horizontal">
	<div class="col-md-12">
		{!! Form::hidden('idsubfuncion', $row['idsubfuncion'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
		{!! Form::hidden('idy', $idy,array('class'=>'form-control', 'placeholder'=>'',   )) !!}
		<div class="form-group  " >
			<label for="Idfuncion" class=" control-label col-md-3 text-left s-16"> Función </label>
			<div class="col-md-9">
				<select name="idfuncion" class="mySelect2" required>
					<option value="">--Select Please--</option>
					@foreach ($rowsFuncion as $p)
						<option value="{{ $p->id }}" @if($p->id == $row['idfuncion']) selected @endif>{{ $p->no_funcion }} - {{ $p->funcion }}</option>
					@endforeach
				</select>
			</div>
		</div> 
		...
		<div class="form-group  " >
			<label for="Numero" class=" control-label col-md-3 text-left s-16"> Número de subfunción </label>
			<div class="col-md-9">
		...
		<div class="form-group  " >
			<label for="Descripcion" class=" control-label col-md-3 text-left s-16"> Subfunción </label>
			<div class="col-md-9">
