...
class proyectopbrmb extends Sximo  {
	
	protected $table = 'ui_proy_pbrm01b';
	protected $primaryKey = 'idproy_pbrm01b';
	...
	*/
	...
	public static function getProgramasAnio($idarea,$idanio){
		return \DB::select("SELECT a.idproy_pbrm01b as id,p.numero as no_programa,p.descripcion as programa,a.url FROM ui_proy_pbrm01b a
	...
	public static function getPbrmb($id){
		return \DB::select("SELECT a.idproy_pbrm01b as id,a.idprograma,p.numero as no_programa,p.descripcion as programa,ar.descripcion as dep_gen,ar.numero as no_dep_gen,ar.titular as titular_dep_gen,
		a.objetivo_programa,a.estrategias_objetivo,a.pdm,a.ods,y.anio,i.descripcion as institucion,
		i.logo_izq,i.logo_der,i.titular_uippe,i.titular_tesoreria,m.descripcion as municipio,m.numero as no_municipio FROM ui_proy_pbrm01b a
		inner join ui_programa p on p.idprograma = a.idprograma
	...
	public static function getPbrmbFoda($id,$type){
		return \DB::select("SELECT idproy_pbrm01b_foda as id,descripcion as foda FROM ui_proy_pbrm01b_foda where idproy_pbrm01b={$id} and type={$type}");
	}
}
